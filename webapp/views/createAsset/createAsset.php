...
<main class="grow-1 p-3 flex flex-col items-center justify-center gap-3">
    <form class="w-[90%] md:w-[50%]">
        <div class="mb-5">
            ...
            <input type="text" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Capteur" required />
        </div>
        <div class="mb-5">
...
<script src="/views/createAsset/createAsset.js"></script>
